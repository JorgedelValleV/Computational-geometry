...
t3 = np.linspace(0.001, 1,5000)
x3 = np.sin(80 * t2/2)**3
y3 = np.cos(80 * t2/2)**3
z3 = np.sqrt(1-x3**2-y3**2)
c3 = x3 + y3
...
ax.plot(x3, y3, z3, '-b',c="red",zorder=3)
#ax.scatter(x3, y3, z3, '-b',c=col,zorder= 3,s=0.1)
...
ax.plot(proj(x3,z3,z0=z0), proj(y3,z3,z0=z0), 1, '-b',c="black",zorder=1)
ax.plot(x3,y3, 0, '-b',c="blue",zorder=1)
ax.plot(proj(x3,z3,z0=z0), proj(y3,z3,z0=z0), 0, '-b',c="red",zorder=1)
#ax.scatter(proj(x3,z3,z0=z0), proj(y3,z3,z0=z0), 1, '-b',c=col,zorder= 3,s=0.1)
